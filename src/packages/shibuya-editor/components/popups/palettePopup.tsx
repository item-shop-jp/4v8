  ...
  return ReactDOM.createPortal(
    popupOpen && (
      <div ref={modalRef}>
        ...
        >
          <Color color="#EF4444" onClick={handleFormatColor} />
          <Color color="#55B938" onClick={handleFormatColor} />
          <Color color="#EAC645" onClick={handleFormatColor} />
          <Color color="#5296D5" onClick={handleFormatColor} />
        </Container>
      </div>
    ),
